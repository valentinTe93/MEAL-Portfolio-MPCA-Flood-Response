...
function formatValue(ind) {
  ...
  if (ind.unit === 'FCFA') {
    return `${ind.followUp.toLocaleString('en-US')} FCFA`;
  }
  ...
  return (
    ...
    >
      ...
      <CardContent sx={{ p: 2.2, position: 'relative' }}>
        ...
        <Typography sx={{ mt: 1, fontWeight: 750, minHeight: 42 }}>
          {ind.label}
        </Typography>
          ...
          <Box sx={{ mt: 1.4 }}>
            ...
            >
              ...
              <Typography variant="caption" fontWeight={800}>
                {ind.unit === '%'
                  ...
                  : ind.baseline.toLocaleString('en-US')}
              </Typography>
            </Stack>
            ...
            <LinearProgress
              ...
              value={Math.min(
                ...
                isPct
                  ? ind.followUp
                  : Math.max(0, Math.min(100, ind.followUp / 70))
              )}
              sx={{
                height: 5,
                borderRadius: 4,
                bgcolor: 'rgba(148,163,184,.10)',
        ...
        {ind.status === 'MEASUREMENT_GAP' && (
          ...
          >
            Required follow-up measurement is unavailable.
          </Typography>
        )}
      ...
      <Stack spacing={3}>
        <Box>
          ...
          >
            <Box>
              ...
              >
                MEAL Decision Intelligence Platform
              </Typography>
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            Outcome indicators show positive movement, while transfer
            completeness and measurement gaps require management attention.
          </Typography>
        </Alert>
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography
                          ...
                          color="text.secondary"
                        >
                          {a.priority} priority · {a.timeline}
                        </Typography>
                      </Box>
                    </Box>
                  ))}
            ...
            >
              <Box>
                ...
                <Typography
                  ...
                  fontWeight={850}
                >
                  Evidence quality is part of the story
                </Typography>
                ...
                <Typography
                  ...
                  sx={{ mt: 0.6 }}
                >
                  The platform keeps uncertainty visible instead of filling
                  gaps with unsupported values.
                </Typography>
              </Box>
              ...
              >
                <Chip
                  label="MEB / SMEB: REQUIRED"
                  color="info"
                  variant="outlined"
                />

                <Chip
                  label="F07: MEASUREMENT GAP"
                  color="secondary"
                  variant="outlined"
                />
              </Stack>
            ...
            >
              <Box sx={{ flex: 1 }}>
                ...
                <Typography
                  ...
                  sx={{ mt: 0.3 }}
                >
                  Descriptive before-and-after analysis. No causal attribution.
                </Typography>
              </Box>
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Typography
                  ...
                  sx={{ mt: 0.3 }}
                >
                  Build the interface around the evidence. Do not generate
                  additional evidence.
                </Typography>
              </Box>
            </Stack>
